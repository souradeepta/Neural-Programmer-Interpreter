...
from tasks.card_pattern_matching.config import CONFIG, PROGRAM_SET
...
CKPT_PATH = "tasks/card_pattern_matching/log/card_pattern_matching_model.ckpt"
TEST_PATH = "tasks/card_pattern_matching/data/card_pattern_matching_test.pik"
